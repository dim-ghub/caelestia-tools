...
MATERIAL_COLOR_MAPPING = {
    ...
    "crust": "inverseSurface",
    "surface0": "surfaceContainerHigh",
    "surface1": "primary",
    "surface2": "outline",
    "flamingo": "surfaceDim",
    "rosewater": "surfaceBright",
    # Text colors
    "text": "onSurface",
    "subtext1": "onSurfaceVariant",
    "subtext0": "onBackground",
    "overlay0": "onBackground",
    "overlay1": "onSurfaceVariant",
    "overlay2": "inversePrimary",
    # Container colors
    "peach": "onPrimaryContainer",
    "yellow": "onSecondaryContainer",
    "green": "onTertiaryContainer",
    "teal": "primaryContainer",
    "sky": "secondaryContainer",
    "sapphire": "tertiaryContainer",
}
...
def convert_to_matugen_var(
    ...
    return f"#{{ {material_color}.{format_type} }}"
...
variable_template = "#{{ {color}.{format} }}"
